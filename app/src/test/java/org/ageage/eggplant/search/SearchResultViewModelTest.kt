...
class SearchResultViewModelTest {
    ...
    @Test
    fun search_onSuccess() = testCoroutineRule.runBlockingTest {
    ...
    @Test
    fun search_onError() = testCoroutineRule.runBlockingTest {
    ...
    @Test
    fun search_emptyItem() = testCoroutineRule.runBlockingTest {
        val mockRepository = mock<FeedRepository> {
    ...
    @Test
    fun search_twice() = testCoroutineRule.runBlockingTest {
        val mockRepository = mock<FeedRepository> {
            onBlocking { search("", defaultSearchFilterOption, 1) } doReturn fakeItems
        }
        val viewModel = SearchResultViewModel(mockRepository)
    ...
    @Test
    fun search_twice_forcibly() = testCoroutineRule.runBlockingTest {
        val mockRepository = mock<FeedRepository> {
            onBlocking { search("", defaultSearchFilterOption, 1) } doReturn fakeItems
        }
        val viewModel = SearchResultViewModel(mockRepository)
    ...
    @Test
    fun loadNextPage_onSuccess() = testCoroutineRule.runBlockingTest {
        val mockRepository = mock<FeedRepository> {
    ...
    @Test
    fun loadNextPage_onError() = testCoroutineRule.runBlockingTest {
        val exception = RuntimeException()
        val mockRepository = mock<FeedRepository> {
    ...
    @Test
    fun loadNextPage_emptyItems() = testCoroutineRule.runBlockingTest {
        val mockRepository = mock<FeedRepository> {
    ...
    @Test
    fun loadNextPage_twice() = testCoroutineRule.runBlockingTest {
        val mockRepository = mock<FeedRepository> {
            onBlocking { search("", defaultSearchFilterOption, 2) } doReturn fakeItems
    ...
    @Test
    fun search_afterLoadNextPage() = testCoroutineRule.runBlockingTest {
        val mockRepository = mock<FeedRepository> {
            onBlocking { search("", defaultSearchFilterOption, 1) } doReturn fakeItems
            onBlocking { search("", defaultSearchFilterOption, 2) } doReturn fakeItems
        }
    ...
    @Test
    fun loadNextPage_afterSearch() = testCoroutineRule.runBlockingTest {
        val mockRepository = mock<FeedRepository> {
            onBlocking { search("", defaultSearchFilterOption, 1) } doReturn fakeItems
            onBlocking { search("", defaultSearchFilterOption, 2) } doReturn fakeItems
        }
